...
**As a** Junior Analyst, **I want** a beautiful, modern desktop application that uses proven open-source chat components with real-time workflow visualization, **so that** I can leverage battle-tested libraries to build workflows faster and more reliably.
